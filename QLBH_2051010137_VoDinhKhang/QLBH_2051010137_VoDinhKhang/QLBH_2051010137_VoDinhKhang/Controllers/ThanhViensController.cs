...
namespace QLBH_2051010137_VoDinhKhang.Areas.Admin.Controllers
{
    public class ThanhViensController : Controller
    {
        ...
        {
            ViewBag.MaPQ = new SelectList(db.PhanQuyens, "MaPQ", "TenQuyen");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "MaThanhVien,TaiKhoan,MatKhau,HoVaTen,DiaChi,Email,SoDienThoai,MaLoaiTV,MaPQ")] ThanhVien thanhVien)
        {
            ...
            ViewBag.MaPQ = new SelectList(db.PhanQuyens, "MaPQ", "TenQuyen", thanhVien.MaPQ);
            return View(thanhVien);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaThanhVien,TaiKhoan,MatKhau,HoVaTen,DiaChi,Email,SoDienThoai,MaLoaiTV,MaPQ")] ThanhVien thanhVien)
        {
            if (ModelState.IsValid)
            {

...
namespace QLBH_2051010137_VoDinhKhang.Controllers
{
    public class GiohangController : Controller
    {
        ...
        public ActionResult Order(string Email, string Phone)
        {
            ...
            MailMessage mail = new MailMessage("2051010137khang@ou.edu.vn", Email, "Thông tin đơn hàng", sMsg);
            SmtpClient client = new SmtpClient("smtp.gmail.com", 587);
            client.EnableSsl = true;
            client.Credentials = new NetworkCredential("2051010137khang", "0395403384");
